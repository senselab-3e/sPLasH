...
var VELOCITY = 1;
			...
			var mouse = {x:0, y:0};
			var particles = [];
			var colors = [ "#086b8f","#81d800","#3c8ed3" ];
			...
			function TimeUpdate(e) {
				...
				for( var i = 0; i < len; i++ ) {
					...
					if (!particle.frozen) {
						...
						distanceFactor = Math.max( Math.min( 20 - ( distanceFactor / 5 ), 10 ), 0.5 );
						//this is where you can control the size of the dots. the 0.5 is the resting min size. the 5 is the distance from the mouse. the 20 is the ration size change. 
